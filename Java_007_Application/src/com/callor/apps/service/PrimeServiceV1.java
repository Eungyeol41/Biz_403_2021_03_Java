 ...
 * 		기존프로젝트를 V1이라고 하고
 * 		새롭게 기능이 개선(추가)되어 배포된 프로젝트를 V2.xx라고 칭하여 배포를 한다
 * 
 */
...
public class PrimeServiceV1 {
	...
	// 여러(2개 이상)의 method에서 공통으로 사용할 변수들은 변수를 사용한다
	// 	== 변수를 참조 : 저장, 읽기
	// 클래스 영역에 설정을 한다
	...
	// 		void 키워드를 사용하지 않는다
	// 		class와 이름이 같다
	// intNums배열을 설정(초기화, 개수 지정)을 하여 사용할 준비를 해야한다
