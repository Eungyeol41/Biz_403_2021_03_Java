...
/*
 * 1 ~ 100까지 범위의 임의의 정수 10개를 만들고 3의 배수인지 검사하여 3의 배수이면 출력하고 수 들의 합을 계산하여 출력하라
 * 
 * 변수의 선언 위치
 * 
 */
public class Controller_12A {
	...
	public static void main(String[] args) {
		 ...
		 * for(), if() 명령문 내에서 사용(저장, 읽기)가 가능하고 for(), if() 명령이 종료되어도 그 값을 유지하고 있다
		 * for() 반복문이 수행되는 동안에 어떤 값을 누적(합산)하거나 할 때 for() 반복문이 시작되기 전에 변수를 반드시 선언하고 0으로 clear하는 것이 좋다
		 */
