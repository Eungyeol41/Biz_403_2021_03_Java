 ...
 * 		Class obj = new Class()
 * 		obj.method() 방식으로는 접근이 안 된다.
 * 		클래스를 상속받게 하겠다라는 전제 하에 상속을 받은 클래스에서는 자유롭게 접근 간으
 * 
...
public class ScoreServiceV1 {
	...
	/*
	 * 멤버변수를 protected로 선언을 해두면 현재클래스(V1)를 상속받은 자식 클래스에서 변수가 선언된 것처럼 동작할 수 있다
	 * 
	...
	public void printScore() {
		...
		for (int i = 0; i < scoreList.size(); i++) {
			// scoreList의 i번째 값을 읽어서 ScoreVO형 sVO 객체에 담기
