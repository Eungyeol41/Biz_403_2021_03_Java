...
public class String_01 {
	...
	public static void main(String[] args) {
		 ...
		 * 		문자열의 독특한 특성 때문에 문자열에 저장된 값이 같은 지 확인이 안 되는 경우가 있다
		 * 
		 * 문자열 변수에 저장된 값이 같은가 비교를 할 때는 문자열.equals("비교대상") method를 사용해야 한다
		 */
//		if(str1 == str2) {
//		if(str2.equals(str1))
		if(str1.equals(str2)) {
		...
		// 영문 문자열이 저장된 경우 대소문자가 달라도 같은 지 비교하기 위해서는 IgnoreCase()를 사용한다
