...
public class ScoreServiceImplV2Ex extends ScoreServiceImplV2 {
	...
	public void inputScore() {
		...
		// 각 과목의 점수를 별도로 입력받아 변수에 저장하기를 하려고 하니 귀찮
		// 창조적 게으름을 피워보자

		// 입력받을 과목명을 변수로 선언하고
		// String[] subject = { "국어", "영어", "수학" };
		// 과목 수만큼 점수를 저장할 배열 선언
		// Integer[] intScore = new Integer[subject.length];
		// intScore 배열을 멤버영역으로 이동 subjectList로 점수를 입력하는 곳에서 사용하기 위하여 과목명을 담을 배열을 선언했는데
		// 생각해보니 다른 implements///....? 그래서 클래스 영역으로 이동하였다
