...
public class Varriable_01 {
	...
	public static void main(String[] args) {
		 ...
		 * 9. println() 덧셈결과가 보관된 기억장소를 찾아가서 보관된 값을 가져와서 system.out한테 보낸다
		...
		System.out.println( 30 % 40 );
		/*
		 *  위 5가지 명령코드에서 숫자 30과 40, 그리고 연산 결과는 기억장치 어딘가에 (임시로) 보관이 되어 연산 수행이 이루어진다
		 *  
		 ...
		 *  
		 *  30과 40이라는 두 숫자를 어떤 지정된 기억장소에 보관해 두고 연산할 때 그 값을 참조하여 연산을 하도록 한다면
